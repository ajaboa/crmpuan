 ...
 * @version $Id: OrderDialog.js 20598 2015-06-17 07:44:26Z mschering $
	...
	syncDueDateFields : function(fromNumber){
		...
		if(fromNumber){
			...
			if(GO.util.empty(dueDate)){
				dueDate = this.bTimeField.getValue();
