			...
			checkColumn,{
				...
				renderer: {
					fn: function(value, metaData, record, rowIndex, colIndex, store) {
						...
						// chack of column is set and have a editer whif displayField
						if(!GO.util.empty(col) && !GO.util.empty(col.getEditor().displayField) && !GO.util.empty(value)) {
							//set display value
							var rec = col.getEditor().getStore().getById(value);
							value = rec.get(col.getEditor().displayField);
						}
						return value;
					},
					scope: this
